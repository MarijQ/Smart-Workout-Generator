...
class Engine():
    ...
    def constants(self):
        ...
        self.BASE_SETS_PER_WEEK = 4  # This can be adjusted between 4 and 12
        self.PIPELINE = []
        ...
        self.TARGET_DURATION = 15         # Total exercise duration in minutes
    ...
    def filter_out_today_entries(self):
        ...
        self.history.to_csv("inputs/history_s.csv", index=False)
